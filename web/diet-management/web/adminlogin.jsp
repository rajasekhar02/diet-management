    ...
    <body background="images/adminlogin.jpg">
        <div class="container">
            <div style="background:transparent !important" class="jumbotron">
                ...
                <center><a href="home.jsp" class="btn btn-info"> Home </a><br></center>
            </div>
        </div>
                ...
                <div class="jumbotron">
                    <center>
                        ...
                        %>
                            ...
                            <tr><td>Enter Password: </td><td><input type="password" name="apwd"></td></tr>
                            <tr><th colspan="2"><center><input type="submit" value="Login"></center></th></tr>
                    </center> 
                </div>
            </div> 
       </form>
